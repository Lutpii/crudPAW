...
import projectPAW.projectPAW.exceptions.NonexistentEntityException;
import projectPAW.projectPAW.exceptions.PreexistingEntityException;
...
public class MenuJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("projectPAW_projectPAW_jar_0.0.1-SNAPSHOTPU");
